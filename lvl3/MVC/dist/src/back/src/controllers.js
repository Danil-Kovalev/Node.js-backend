 ...
 */
async function requestBooks(req) {
 ...
 */
async function requestSearchBooks(text) {
    let result;
    let dataReady;
 ...
 */
export async function addClick(req, res) {
 ...
 */
export function authorizer(username, password) {
